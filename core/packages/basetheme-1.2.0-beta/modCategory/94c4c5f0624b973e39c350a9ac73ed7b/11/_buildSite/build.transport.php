...
$sources = array(
	'root' => $root,
	'build' => $root . '_buildSite/',
	'data' => $root . '_buildSite/data/',
	'resolvers' => $root . '_buildSite/resolvers/',
    'subpackages' => $root . '_buildSite/subpackages/',
...
$builder->createPackage(PKG_NAME_ALTER,PKG_VERSION,PKG_RELEASE);
