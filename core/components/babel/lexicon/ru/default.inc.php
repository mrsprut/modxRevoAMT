...
/* titles */
$_lang['header_title'] = 'ООО "НПП ИЦ "АЗОВМАШТЕСТ"*';
$_lang['header_sup_title'] = ' Испытания продукции вагоностроения и тяжелого машиностроения';
$_lang['test_history_n_today_title'] = 'Испытания: история и современность';
$_lang['backcall_title'] = 'Мы всегда рады вам помочь';
$_lang['backcall_subtitle'] = 'Напишите нам или задайте вопрос';

/* menu items */
$_lang['main_item'] = 'Главная';
$_lang['history_item'] = 'История';
$_lang['services_item'] = 'Услуги';
$_lang['events_item'] = 'Примеры';
$_lang['specialists_item'] = 'Специалисты';
$_lang['contact_item'] = 'Контакты';

/* buttons */
$_lang['main_more_button'] = 'Узнать больше';
$_lang['more_button'] = 'ПОДРОБНЕЕ';
$_lang['send_button'] = 'Отправить';

/* placeholders */
$_lang['name_placeholder'] = 'Имя';
$_lang['e-mail_placeholder'] = 'E-mail';
$_lang['subject_placeholder'] = 'Тема';
$_lang['message_placeholder'] = 'Сообщение';

/* labels */
$_lang['reqired_label'] = '― Отмеченные поля обязательны для заполнения';
//$_lang['send_button'] = 'Отправить';

/*FormIt messages*/
$_lang['success_message'] = 'Ваше сообщение было отправлено. ';
$_lang['error_message'] = 'Все поля должны быть заполнены. ';
$_lang['e-error_email_message'] = 'Пожалуйста, введите действительный адрес электронной почты. ';

/*address strings*/
$_lang['address_name_string'] = 'ООО "Научно-производственное предприятие Испытательный центр "Азовмаштест"';
$_lang['address_address_string'] = 'пл. Машиностроителей, 1, г. Мариуполь, Донецкая область, Украина, 87535';
