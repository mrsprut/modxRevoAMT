appMakeBeCool.gateway.addClass('Menu', function(properties, $, $window, $document) {
    ...
    _defaults = {
        ...
        menu: '#touch',
        nav: '#nav',
        mainNavLi: '.mainNav li a',
        siteNavLi: '.siteNav li a'
        // prop
        // data
        // classes ans styles
    },
    ...
    _config = function() {
        ...
        _globals.mainNavLi = $(_properties.mainNavLi);
        _globals.siteNavLi = $(_properties.siteNavLi);
    },
    ...
    _menuF = function(){
        ...
        _globals.mainNavLi.click(function(){
            _globals.nav.toggleClass('active');
        });
        _globals.siteNavLi.click(function(){
            _globals.nav.toggleClass('active');
        });
    },
